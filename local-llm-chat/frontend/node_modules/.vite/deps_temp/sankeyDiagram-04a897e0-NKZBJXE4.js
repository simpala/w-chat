...
var draw = function(text, id, _version, diagObj) {
  ...
  const width = (_a = conf == null ? void 0 : conf.width) != null ? _a : defaultSankeyConfig.width;
  const height = (_b = conf == null ? void 0 : conf.height) != null ? _b : defaultSankeyConfig.width;
  const useMaxWidth = (_c = conf == null ? void 0 : conf.useMaxWidth) != null ? _c : defaultSankeyConfig.useMaxWidth;
  const nodeAlignment = (_d = conf == null ? void 0 : conf.nodeAlignment) != null ? _d : defaultSankeyConfig.nodeAlignment;
  const prefix = (_e = conf == null ? void 0 : conf.prefix) != null ? _e : defaultSankeyConfig.prefix;
  const suffix = (_f = conf == null ? void 0 : conf.suffix) != null ? _f : defaultSankeyConfig.suffix;
  const showValues = (_g = conf == null ? void 0 : conf.showValues) != null ? _g : defaultSankeyConfig.showValues;
...
//# sourceMappingURL=sankeyDiagram-04a897e0-NKZBJXE4.js.map
