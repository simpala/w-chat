...
var cherryPick = function(sourceId, targetId, tag, parentCommitId) {
  ...
  if (!targetId || commits[targetId] === void 0) {
    ...
    const commit2 = {
      ...
      tag: tag != null ? tag : `cherry-pick:${sourceCommit.id}${sourceCommit.type === commitType$1.MERGE ? `|parent:${parentCommitId}` : ""}`
    };
    head = commit2;
    commits[commit2.id] = commit2;
    branches[curBranch] = commit2.id;
...
//# sourceMappingURL=gitGraphDiagram-72cf32ee-QH63XCOD.js.map
