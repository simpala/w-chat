...
var draw = (text, id, _version, diagObj) => {
  ...
  const longestTextWidth = Math.max(
    ...legend.selectAll("text").nodes().map((node) => {
      var _a;
      return (_a = node == null ? void 0 : node.getBoundingClientRect().width) != null ? _a : 0;
    })
  );
...
//# sourceMappingURL=pieDiagram-8a3498a8-NKJMBZ64.js.map
